<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                <div class="p-6 text-gray-900 flex" style="justify-content: center; gap: 10px">
                    <a class="card pc-card" href="{{ route('gest_pc') }}"
                        style="margin-top: 1%; max-width: 16%; display: flex; flex-direction: column; justify-content:flex-start; height: auto;">
