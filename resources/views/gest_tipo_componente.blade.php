    ...
    <x-slot name="header">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tipos de componentes</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        Aqui debes agregar el tipos de componentes (RAM, Motherboard, Procesador, Perifericos, etc)
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Agregar nuevo tipo</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('store_tipo') }}" method="POST" id="addModal">
                            ...
                            <div class="mb-3">
                                <label for="addNombre" class="form-label">Tipo:</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('edit_tipo') }}" method="POST" id="addModal">
                            ...
                            <div class="mb-3">
                                <label for="editNombre" class="form-label">Tipo:</label>
